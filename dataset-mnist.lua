-- this fils is from https://github.com/torch/demos/blob/master/train-a-digit-classifier/dataset-mnist.lua
-- credits: 
--   soumith        : https://github.com/soumith
--   clementfarabet : https://github.com/clementfarabet
--   samorajp       : https://github.com/samorajp
-- 
require 'torch'
require 'paths'
